var _value = [
    ...
    // 3구간 테이블 데이터
    ['75','100','1,700','4,200'],           // section7 굴진현황
    ['16','5'],                             // section8 출역현황
    ['21','5','12','25'],                   // section9 환경현황

    // 4구간 테이블 데이터
    ['75','100','1,700','4,200'],           // section10 굴진현황
    ['16','5'],                             // section11 출역현황
    ['21','5','12','25'],                   // section12 환경현황

    // 터널 진행 상황도
    ['32','6','7','8','9'],                 // section13 현장 작업자
    ['10','3','2','2','3'],                 // section14 현장 중장비
    ['75','100'],                           // section15 전체 굴착 진행율 그래프
    ['2,345','4,855'],                      // section16 전체 굴착 진행 거리

    // 터널 그래프 데이터
    ['45','100','1,700','7','2'],               // section17 터널1 데이터
    ['72','100','1,200','9','3'],               // section18 터널2 데이터
    ['72','100','1,600','9','3'],               // section19 터널3 데이터
    ['72','100','1,100','9','3'],               // section20 터널4 데이터
]
